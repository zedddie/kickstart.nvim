...
require('lazy').setup {
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- 'WhoIsSethDaniel/mason-tool-installer.nvim', turn off while use NixOS
    ...
    config = function()
      ...
      -- require('mason-tool-installer').setup { ensure_installed = ensure_installed } turn off while using nixos
